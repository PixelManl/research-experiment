...
| [staged-task-expansion.md](./staged-task-expansion.md) | PRD stage expansion protocol for continuous research threads | Deciding whether to append Stage A/B/C/G0/G1/G2 or create a new Trellis task | Must Read |
...
Extending an ongoing Trellis task with Stage A/B/C/G0/G1/G2?
