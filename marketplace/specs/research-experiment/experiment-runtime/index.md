...
| [python-command.md](./python-command.md) | Cross-platform Python interpreter and command rules | Running helper scripts, writing canonical commands, moving across Windows/Linux/macOS | Must Read |
...
- Python commands must use the verified project interpreter; agents must not silently swap `python` and `python3`.
